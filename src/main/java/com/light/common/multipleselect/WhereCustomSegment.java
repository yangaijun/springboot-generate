...
public class WhereCustomSegment { 
	...
	private String currentOperationType = "AND";
	...
	public WhereCustomSegment or() {
		if (!this.currentOperationType.equals("OR"))
			this.currentOperationType = "OR";
		return this;
	}
	public WhereCustomSegment and() {
		if (!this.currentOperationType.equals("AND"))
			this.currentOperationType = "AND";
		return this;
	}
	...
	public WhereCustomSegment division() {
		if (this.lastDivisionType() == rightDivision) {
			segmentSql.add(" " + getOperationType() + " (");
		} else {
			segmentSql.add(") " + getOperationType() + " (");
		}
		return this;
	...
	public WhereCustomSegment sql(String sql, Object[] params) {
		  StringBuffer segmentSql = new StringBuffer(getOperationType() + " ");
